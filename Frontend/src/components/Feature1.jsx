...
function Feature1(){
    return (
        <>
        <div className="feature1-main-div">
            <div className="feature1-text-div">
                <h1 className="feature1-heading-text1">Intelligent <span className="feature1-heading-text2">Code Editor</span></h1>
                <p className="feature1-subheadng">Automate your development with a seamless Cloud IDE experience. Write, run, and submit your code with lightning speed, delivering precision-engineered results and instant feedback.</p>
            </div>
            ...
            <div className='plan-btn-div'>
                <Link to="/premium">
                    <button className='plan-btn-mera'>See Plans <i className="ri-contract-right-line"></i></button>
                </Link>
            </div>
        </div>
        </>
