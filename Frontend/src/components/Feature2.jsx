                        ...
                        {[...Array(repetitions)].map((_, idx) => (
                            <div className="marquee__part" key={idx} style={{ color: marqueeTextColor }}>
                                ...
                                <div className="marquee__img">
                                    <img src={image} className='my-img'></img>
                                </div>
                            </div>
                        ))}
                    </div>
...
function Feature2(){
    return (
        ...
        <div className="feature2-main-div">
            <div className="feature2-text-div">
                <h1 className="feature2-heading-text1">The <span className="feature2-heading-text2">Golden</span> Trinity</h1>
                <p className='feature2-description'>We provide isolated, professional-grade sandboxes for the three languages that define the modern software development.</p>
            </div>
